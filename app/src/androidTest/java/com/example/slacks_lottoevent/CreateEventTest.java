...
public class CreateEventTest {
    ...
    public void testPriceValidation() {
        ...
        onView(withId(R.id.event_price)).check(matches(ViewMatchers.hasErrorText("Price must be a valid number (e.g., 29.99)")));

        onView(withId(R.id.event_price)).perform(replaceText("29.99"));
    ...
    public void testSlotsValidation() {
        ...
        onView(withId(R.id.eventSlots)).check(matches(ViewMatchers.hasErrorText("Slots must be a number")));

        onView(withId(R.id.eventSlots)).perform(replaceText("10"));
