...
public class FacilityListArrayAdapter extends ArrayAdapter<Facility> {
     ...
     */
    public static void showFacilityOptionsDialog(Context context, FirebaseFirestore db,
                                                 Facility facility,
                                                 OrganizerEventArrayAdapter eventsAdapter,
        ...
        if (!FromProfile) {
            ...
            AdminActivity.showAdminAlertDialog(context, () ->
                                                       AdminActivity.showAdminAlertDialog(context,
                                                                                          () -> deleteFacilityFromDatabase(context, db,
                                                                                                                           facility.getDeviceId(),
                                                                                                                           eventsAdapter,
                                                                                                                           facilitiesAdapter),
                                                                                          // Reference to the events adapter
                                                                                          "Confirm Deletion",
     ...
     */
    public static void deleteFacilityFromDatabase(Context context, FirebaseFirestore db,
                                                  String deviceId,
                                                  OrganizerEventArrayAdapter eventsAdapter,
                                                  FacilityListArrayAdapter facilitiesAdapter) {
...
//                                          Delete each event document explicitly
                            ...
                            db.collection("organizers").document(deviceId).delete()
                              .addOnSuccessListener(success -> {
                                  Toast.makeText(context, "Organizer data deleted successfully.",
                              ...
                              .addOnFailureListener(e -> {
                                  Toast.makeText(context, "Failed to delete organizer data: " +
                            ...
                            db.collection("facilities").document(deviceId).delete()
                              .addOnSuccessListener(success -> { // Rename 'aVoid' to 'success'
                                  ...
                                  Toast.makeText(context, "Facility deleted successfully.",
                                                 Toast.LENGTH_SHORT).show();
                              })
                              .addOnFailureListener(e -> {
                                  // Handle failure
                                  Toast.makeText(context,
                                                 "Failed to delete facility: " + e.getMessage(),
                                                 Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(e -> {
                    Toast.makeText(context, "Failed to fetch organizer details: " + e.getMessage(),
                                   Toast.LENGTH_SHORT).show();
                });
          })
          .addOnFailureListener(e -> {
              Toast.makeText(context, "Failed to delete facility: " + e.getMessage(),
                             Toast.LENGTH_SHORT).show();
          });
    }
        ...
        if (facility != null) {
            ...
            if (isAdmin) {
                ...
                ovalButton.setOnClickListener(
                        v -> showFacilityOptionsDialog(context, db, facility, eventsAdapter, this,
                                                       false));
