...
// */
//public class UserNotificationsArrayAdapter extends ArrayAdapter<Entrant> implements Serializable {
//    //and then get that entrant of which u want, and then take
//    private User currentUser;
//    public UserNotificationsArrayAdapter(@NonNull Context context, Entrant entrant) {
//        super(context, 0, entrant.getInvitedEvents());
//    }
//
//    @NonNull
//    @Override
